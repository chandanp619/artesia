...
class SingleHomes extends Controller implements Tree
{
    use Helpers\Post;
    use Helpers\Components;
    use Partials\Banner;
    use Partials\HomeTile;
    use Partials\Gallery;
    use Partials\HomeDetails;
    use Partials\PanelMenu;
    use Partials\FullWidthPanel;
    use Partials\SecondaryContentBlock;
...
//    }
    ...
    public static function homeURL(){
        global $post;
        $homeURL = get_post_meta($post->ID,'_home_external_url',true);
        if($homeURL=="")
